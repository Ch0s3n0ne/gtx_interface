...
HD_PWD='C:/Users/huhug/FPGA_workspace/Doutoramento/gtx_interface/gtwizard_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_input_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_input_clock.tcl -notrace
