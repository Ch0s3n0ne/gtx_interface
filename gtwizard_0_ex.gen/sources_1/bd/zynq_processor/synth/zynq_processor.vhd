...
--Date        : Thu Apr 27 15:56:24 2023
--Host        : LAPTOP-UAA2KK37 running 64-bit major release  (build 9200)
--Command     : generate_target zynq_processor.bd
--Design      : zynq_processor
...
entity zynq_processor is
  ...
  attribute CORE_GENERATION_INFO of zynq_processor : entity is "zynq_processor,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=zynq_processor,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=3,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of zynq_processor : entity is "zynq_processor.hwdef";
end zynq_processor;

architecture STRUCTURE of zynq_processor is
  component zynq_processor_processing_system7_0_0 is
  port (
  ...
  end component zynq_processor_processing_system7_0_0;
...
begin
processing_system7_0: component zynq_processor_processing_system7_0_0
     port map (
