...
#
# Generated by export_simulation on Thu Apr 27 15:56:27 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './zynq_processor.sh' script.

./zynq_processor.sh -reset_run
...
./zynq_processor.sh -noclean_files

For more information on the script, please type './zynq_processor.sh -help'.
